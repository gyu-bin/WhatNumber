...
const MARKS = [
  ...
  { key: 'hyundai-fire', bg: '#E60012', fg: '#FFFFFF', label: '현대', fontSize: 40 },
  { key: 'meritz-fire', bg: '#C8102E', fg: '#FFFFFF', label: '메리', fontSize: 40 },
  { key: 'hanwha-insure', bg: '#F37321', fg: '#FFFFFF', label: '한화', fontSize: 40 },
  { key: 'lotte-insure', bg: '#E60012', fg: '#FFFFFF', label: '롯데', fontSize: 40 },
  { key: 'heungkuk-fire', bg: '#003DA5', fg: '#FFFFFF', label: '흥국', fontSize: 40 },
  { key: 'mg-insure', bg: '#00A0E3', fg: '#FFFFFF', label: 'MG', fontSize: 48 },
  { key: 'axa-insure', bg: '#00008F', fg: '#FFFFFF', label: 'AXA', fontSize: 40 },
  { key: 'hana-insure', bg: '#009178', fg: '#FFFFFF', label: '하나', fontSize: 40 },
  { key: 'carrot-insure', bg: '#FF6B00', fg: '#FFFFFF', label: '캐롯', fontSize: 40 },
